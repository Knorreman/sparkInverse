...
object Main {
  ...
  def runBenchmark(sc: SparkContext, n: Int, schurBlockSize: Int, nsBlockSize: Int,
    ...
    // --- Schur complement (small blockSize keeps localInv base cases small) ---
    ...
    BenchResult(n, schurBlockSize, nsBlockSize, schurLimit, schurMidSplits, nsMidSplits, schurTime, schurRmse, iterTime, iterRmse, 0)
  }
